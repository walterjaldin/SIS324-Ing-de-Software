class Complex {
    ...
    static toComplex(str) {
      ...
      if (match) {
        ...
        throw new Error("Invalid format for toComplex");
      }
    }
  }
  
  try {
    const num1 = Complex.toComplex("8 + 5i");
    const num2 = Complex.toComplex("1 - 2i");
    ...
    console.log("\nEstudiante : Walter Jaldin Gonzales Grupo : 2");
  } catch (e) {
